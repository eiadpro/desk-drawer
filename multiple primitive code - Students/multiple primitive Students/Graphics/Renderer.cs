...
namespace Graphics
{
    class Renderer
    {
        ...
        public void Draw()
        {
            ...
            //// 3 - Arms
            Gl.glDrawArrays(Gl.GL_LINE_STRIP, 5,3);
			Gl.glDrawArrays(Gl.GL_LINE_STRIP, 8, 3);
			//// 4 - Fan
			Gl.glDrawArrays(Gl.GL_TRIANGLE_FAN, 11, 6);
			//// 5 - legs
			Gl.glDrawArrays(Gl.GL_TRIANGLES, 17, 3);
			Gl.glDrawArrays(Gl.GL_TRIANGLES, 20, 3);
			//// 6 - Nose 
			Gl.glDrawArrays(Gl.GL_LINE_LOOP, 23, 4);
			//// 7 - Mouth
			Gl.glDrawArrays(Gl.GL_LINES, 27, 2);
			Gl.glDrawArrays(Gl.GL_LINES, 29, 2);
